...
export const projects: Project[] = [
  ...
  },
  {
    ...
    unitTypes: ["2 Bedroom Premium Units", "Spacious Apartments", "Open Lounge"],
  ...
  },
  {
    ...
    summary:
      "Apartment towers on Water Corporation Drive, Victoria Island.",
    description: [
  ...
  },
  {
    ...
    summary:
      "Resort-style residences and leisure amenities in Katampe, Abuja.",
    description: [
...
export function getProject(company: string, slug: string) {
  return projects.find(
    (p) => p.slug === slug && p.company.slug === company
  );
}
