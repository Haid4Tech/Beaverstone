...
export const projects: Project[] = [
  ...
  // },
  {
    ...
    company: grenadines,
    name: 'Roceilli',
    location: 'Grace City Estate 1, Idu Airport Road, Abuja',
    status: 'Ongoing',
    category: 'Gated Townhomes',
    tagline: "Vertical living, close to the water's edge.",
    summary:
      'A gated township of townhomes off the Dei-Dei Kubwa Expressway, Abuja.',
    description: [
    ...
    neighbourhood: {
      name: 'Idu, Abuja',
      copy: 'Grace City Estate sits along Idu Airport Road, a fast-growing corridor close to the Nnamdi Azikiwe International Airport.',
    },
    mapQuery: 'Grace City Estate 1, Idu Airport Road, Abuja, Nigeria',
  },
  {
    slug: 'brooksville',
    company: grenadines,
    name: 'Brooksville',
    location: 'Hutu Pent Haven, Airport Road, Lugbe, Abuja',
    status: 'Currently Selling',
    category: 'Sky Villas',
    tagline: 'The privacy of a villa, carried into the air.',
    summary: 'Full-floor sky villas on Airport Road, Lugbe, Abuja.',
    description: [
    ...
    gallery: [u(IMG.extraA), u(IMG.kadars), u(IMG.cerulean), u(IMG.extraB)],
    amenities: [
      '24/7 Security',
      'Private Lift Lobby',
      'Swimming Pool',
    ...
    neighbourhood: {
      name: 'Lugbe, Abuja',
      copy: 'Hutu Pent Haven sits along Airport Road in Lugbe, a fast-developing district close to the Nnamdi Azikiwe International Airport.',
    },
    mapQuery: 'Hutu Pent Haven, Airport Road, Lugbe, Abuja, Nigeria',
  },
  // {
  //   slug: 'claren-villas',
  //   company: grenadines,
