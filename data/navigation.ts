...
export const navigation: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Paltonloitte Limited", href: "/member-companies/paltonloitte-limited" },
      { label: "Oceanna Development", href: "/member-companies/oceanna-development" },
      { label: "Micherutti Contractors", href: "/member-companies/micherutti-contractors" },
      { label: "Palton Morgan Capital", href: "/member-companies/palton-morgan-capital" },
    ],
  },
  {
    label: "Projects",
    ...
    children: [
      ...
      { label: "The Rockhampton", href: "/projects/grenadines-homes/the-rockhampton" },
