...
const expertise = [
  {
    ...
    icon: (
      <path d="M4 21V10l8-6 8 6v11M9 21v-7h6v7" />
    ),
  },
  {
    title: "Brokerage",
  ...
  },
  {
    ...
    icon: (
      <path d="m14.5 3.5 6 6L9 21H3v-6zM12 6l6 6" />
    ),
  },
  {
    title: "Capital",
    ...
    icon: (
      <path d="M3 17V9l9-6 9 6v8M3 21h18M7 21v-6h4v6" />
    ),
  },
];
  ...
  return (
    <section className="relative overflow-hidden bg-ink py-24 text-white lg:py-32">
      ...
      <div className="relative mx-auto max-w-[1400px] px-6 lg:px-12">
        ...
        <Reveal delay={0.1}>
          <h2 className="font-display max-w-2xl text-4xl font-light leading-[1.1] lg:text-7xl">
            Expertise
          </h2>
        </Reveal>
