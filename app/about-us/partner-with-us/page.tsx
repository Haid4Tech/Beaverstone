    ...
    <>
      ...
      <section className="mx-auto max-w-[1400px] px-6 py-24 lg:px-12 lg:py-32">
        ...
        <Stagger className="mt-16 grid gap-px overflow-hidden border border-line sm:grid-cols-3">
          {partnerships.map((p, i) => (
            <StaggerItem key={p.title} className="border-line bg-white p-8 sm:border-l first:sm:border-l-0">
              <span className="font-display text-3xl text-gold">
                {String(i + 1).padStart(2, "0")}
              </span>
              <h3 className="font-display mt-4 text-xl text-ink-warm">
                {p.title}
              </h3>
      ...
      <section className="bg-cream py-24 lg:py-32">
        <div className="mx-auto max-w-[720px] px-6 lg:px-12">
          <Reveal>
            <h2 className="font-display text-center text-3xl font-light leading-tight text-ink-warm lg:text-4xl">
          ...
          <Reveal delay={0.1}>
            <form className="mt-10 grid gap-6 sm:grid-cols-2">
              <div className="sm:col-span-1">
                <label htmlFor="pw-name" className="mb-2 block text-[13px] text-body">
                  Full Name
                </label>
                <input
                  id="pw-name"
              ...
              <div className="sm:col-span-1">
                <label htmlFor="pw-email" className="mb-2 block text-[13px] text-body">
                  Email Address
                </label>
                <input
                  id="pw-email"
              ...
              <div className="sm:col-span-2">
                <label htmlFor="pw-type" className="mb-2 block text-[13px] text-body">
                  Partnership Type
                </label>
                <select
                  id="pw-type"
              ...
              <div className="sm:col-span-2">
                <label htmlFor="pw-message" className="mb-2 block text-[13px] text-body">
                  Message
                </label>
                <textarea
                  id="pw-message"
